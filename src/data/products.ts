...
const generateCarBikeAccessoriesProducts = (): Product[] => {
  ...
  const carBikeNames = [
    ...
    "Car Antenna", "Bike Lock", "Chain Lock", "Disc Lock", "Helmet Lock",
    "Car Jack", "Bike Stand", "Car Lift", "Tool Box", "Wrench Set",
    "Screwdriver Set", "Plier Set", "Oil Filter", "Air Filter", "Fuel Filter",
    "Spark Plug", "Car Battery", "Bike Battery", "Wiper Blade", "Brake Pad",
    "Clutch Plate", "Drive Belt", "Car Cover", "Bike Cover", "Seat Cover",
    "Handle Grip", "Foot Rest", "Carrier Box", "Tank Bag", "Saddle Bag",
    "Car Organizer", "Trunk Organizer", "First Aid Kit", "Fire Extinguisher", "Warning Triangle",
    "Reflective Tape", "Safety Vest", "Car Polish", "Wax Spray", "Glass Cleaner",
    "Tire Cleaner", "Wheel Brush", "Wash Mitt", "Drying Towel", "Pressure Washer",
    "Steam Cleaner", "Foam Gun", "Car Shampoo", "Bike Shampoo", "Degreaser",
    "Engine Cleaner", "Interior Cleaner", "Upholstery Cleaner", "Vinyl Protectant", "Rubber Conditioner",
    "Paint Protection Film", "Ceramic Coating", "Scratch Remover", "Touch Up Paint", "Rust Converter",
    "Undercoating Spray", "Car Alarm System", "Bike Alarm", "Central Locking", "Remote Start",
    "Immobilizer", "GPS Tracker", "Security Camera", "Parking Lock", "Wheel Clamp",
    "Car Tent", "Roof Rack", "Bike Rack", "Ski Rack", "Cargo Carrier",
    "Hitch Mount", "Tow Bar", "Car Trailer", "Bike Trailer", "Luggage Carrier",
    "Roof Box", "Car Awning", "Camping Chair", "Portable Table", "Cooler Box",
    "Power Inverter", "Solar Panel", "LED Strip Light", "Ambient Light", "Work Light",
    "Fog Lamp", "Driving Light", "Search Light", "Emergency Light", "Strobe Light",
    "Car Winch", "Recovery Strap", "Tow Rope", "Shackle", "Pulley Block",
    "Tire Pressure Monitor", "OBD Scanner", "Code Reader", "Multimeter", "Test Light",
    "Compression Tester", "Timing Light", "Fuel Pressure Gauge", "Vacuum Gauge", "Temperature Gauge"
  ];
